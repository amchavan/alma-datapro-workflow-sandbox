...
public class Envelope extends CouchDbRecord implements Message, Comparable<Envelope> {
	...
	public Envelope( Message message, String creationTimestamp, String originIP,
						    String queueName ) {
		super( makeID(), null );
	...
	public int compareTo( Envelope other ) {
		Envelope otherMessage = (Envelope) other;
